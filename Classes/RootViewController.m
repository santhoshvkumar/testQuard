...
@property (nonatomic, strong) EKEventStore *eventRemainder;
...
- (void)viewDidLoad
{
    ...
    self.eventRemainder = [[EKEventStore alloc] init];
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    [self getAllRemainder];
}

-(void) getAllRemainder{
    
    NSPredicate *predicate = [self.eventRemainder predicateForRemindersInCalendars:nil];
    [self.eventRemainder fetchRemindersMatchingPredicate:predicate completion:^(NSArray *reminders) {
        for (EKReminder *reminder in reminders) {
            // do something for each reminder
             NSLog(@"Stirng %@",reminder.title);
        }
    }];
}
